...
export function TakeoverInitiateModal({ business, onClose }) {
  ...
  const handleTakeover = async () => {
    ...
    if (parseFloat(user?.cash || 0) < bidAmount) {
      setResult({ success: false, message: 'Insufficient funds.' }); return
    }
    sounds.tap()
    setLoading(true)
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: 'linear-gradient(180deg, #1C0A0A 0%, #0E0F18 100%)',
